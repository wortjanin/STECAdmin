...
AItem{
	...
	protected String getLoadQuery() {
		return Kurs.sLoadQuery;
	} 
	@Override
	protected String getInsertQuery() {
		return Kurs.sInsertQuery;
	} 
	@Override
	protected String getUpdateQuery() {
		return Kurs.sUpdateQuery;
	} 
	@Override
	protected String getDeleteQuery() {
		return Kurs.sDeleteQuery;
	} 
	 ...
	 */
	private static final Kurs m_def = new Kurs();  
	/**
	...
	public String getLastIdQuery(){
		return "SELECT sq_div_kurs_i.currval FROM DUAL";
	}
	...
	public void setCanSelect(boolean canSelect){
		Kurs.Inner.canSelect = canSelect;
	}
	@Override
	public boolean canSelect(){
		return 	Kurs.Inner.canSelect;
	}
	
	@Override
	public void setCanInsert(boolean canInsert){
		Kurs.Inner.canInsert = canInsert;
	}
	@Override
	public boolean canInsert(){
		return 	Kurs.Inner.canInsert;
	}

	@Override
	public void setCanUpdate(boolean canUpdate){
		Kurs.Inner.canUpdate = canUpdate;
	}
	@Override
	public boolean canUpdate(){
		return 	Kurs.Inner.canUpdate;
	}

	@Override
	public void setCanDelete(boolean canDelete){
		Kurs.Inner.canDelete = canDelete;
	}
	@Override
	public boolean canDelete(){
		return 	Kurs.Inner.canDelete;
	}
		...
		public Kurs(BigDecimal id, boolean forUpdate)  throws SQLException {
			this();
			this.setID(id);
			load(forUpdate);
		}

		public static Kurs getDef(){
			return Kurs.m_def;
		}
		...
		public static final class zzzNameAttr extends IAttr{
			...
			public String           getCaption()			{ return "Название курса"; }  
			public boolean          getDbIsCombo()			{ return true; }  
