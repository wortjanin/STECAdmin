...
* Группа
*/
public class GroupUniver extends 
AItem{
	@Override
	...
	protected String getLoadQuery() {
		return GroupUniver.sLoadQuery;
	} 
	@Override
	protected String getInsertQuery() {
		return GroupUniver.sInsertQuery;
	} 
	@Override
	protected String getUpdateQuery() {
		return GroupUniver.sUpdateQuery;
	} 
	@Override
	protected String getDeleteQuery() {
		return GroupUniver.sDeleteQuery;
	} 
	 ...
	 */
	private static final GroupUniver m_def = new GroupUniver();  
	/**
	...
	public void setCanSelect(boolean canSelect){
		GroupUniver.Inner.canSelect = canSelect;
	}
	@Override
	public boolean canSelect(){
		return 	GroupUniver.Inner.canSelect;
	}
	
	@Override
	public void setCanInsert(boolean canInsert){
		GroupUniver.Inner.canInsert = canInsert;
	}
	@Override
	public boolean canInsert(){
		return 	GroupUniver.Inner.canInsert;
	}

	@Override
	public void setCanUpdate(boolean canUpdate){
		GroupUniver.Inner.canUpdate = canUpdate;
	}
	@Override
	public boolean canUpdate(){
		return 	GroupUniver.Inner.canUpdate;
	}

	@Override
	public void setCanDelete(boolean canDelete){
		GroupUniver.Inner.canDelete = canDelete;
	}
	@Override
	public boolean canDelete(){
		return 	GroupUniver.Inner.canDelete;
	}
		...
		public GroupUniver(BigDecimal id, boolean forUpdate)  throws SQLException {
			this();
			this.setID(id);
			load(forUpdate);
		}

		public static GroupUniver getDef(){
			return GroupUniver.m_def;
		}
		...
		public static final class zzzNameAttr extends IAttr{
			...
			public String           getCaption()			{ return "Название группы"; }  
			public boolean          getDbIsCombo()			{ return true; }  
		...
		public static final class zzzTechNameAttr extends IAttr{
			...
			public String           getCaption()			{ return "Техническое название группы"; }  
