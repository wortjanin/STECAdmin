...
* Группа
*/
public class StecGroup extends 
AItem{
	@Override
	...
	protected String getLoadQuery() {
		return StecGroup.sLoadQuery;
	} 
	@Override
	protected String getInsertQuery() {
		return StecGroup.sInsertQuery;
	} 
	@Override
	protected String getUpdateQuery() {
		return StecGroup.sUpdateQuery;
	} 
	@Override
	protected String getDeleteQuery() {
		return StecGroup.sDeleteQuery;
	} 
	 ...
	 */
	private static final StecGroup m_def = new StecGroup();  
	/**
	...
	public String getLastIdQuery(){
		return "SELECT sq_stec_group_i.currval FROM DUAL";
	}
	...
	public void setCanSelect(boolean canSelect){
		StecGroup.Inner.canSelect = canSelect;
	}
	@Override
	public boolean canSelect(){
		return 	StecGroup.Inner.canSelect;
	}
	
	@Override
	public void setCanInsert(boolean canInsert){
		StecGroup.Inner.canInsert = canInsert;
	}
	@Override
	public boolean canInsert(){
		return 	StecGroup.Inner.canInsert;
	}

	@Override
	public void setCanUpdate(boolean canUpdate){
		StecGroup.Inner.canUpdate = canUpdate;
	}
	@Override
	public boolean canUpdate(){
		return 	StecGroup.Inner.canUpdate;
	}

	@Override
	public void setCanDelete(boolean canDelete){
		StecGroup.Inner.canDelete = canDelete;
	}
	@Override
	public boolean canDelete(){
		return 	StecGroup.Inner.canDelete;
	}
		...
		public StecGroup(BigDecimal id, boolean forUpdate)  throws SQLException {
			this();
			this.setID(id);
			load(forUpdate);
		}

		public static StecGroup getDef(){
			return StecGroup.m_def;
		}
		...
		public static final class zzzIdAttr extends IAttr{
			...
			public String           getDbColumnName()		{ return "STEC_GROUP_ID"; }  
